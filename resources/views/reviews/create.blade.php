                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default">
                    ...
                    <form action="/genres" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> User <span class="text-meta-1">*</span> 
                                </label>
                                <input
                                    id="user"
                                    name="user"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Rating <span class="text-meta-1">*</span> 
                                </label>
                                <input
                                    id="rating"
                                    name="rating"
